...
export const menus: MenuItem[] = [
    {
        ...
        seo: {
            ...
            description:
                "실제 겪었던 비포에프터클린 후기와 A/S 후기를 투명하게 작성하였습니다. 느낀 점 그대로 내돈내산 리얼 후기 입니다.",
            canonical: `${siteConfig.url}/`,
            ogImage: `${siteConfig.url}/images/review/before-room-dust-main.jpg`,
            schemaType: "WebPage",
        },
    },
    {
        ...
        seo: {
            ...
            description: '추가금 포함 총 63만원, 평당 2만원이 넘는 비포에프터클린 입주청소 솔직 후기입니다. 분진 제거, 새집증후군 증빙 부재 등 사실 그대로를 공유합니다.',
            openGraph: {
                title: `63만원 날린 안양 입주청소 비추천 후기 | ${siteConfig?.name}`,
                description: '분진 많다고 추가금 받았으면서 레일엔 먼지가 수북? A/S 후에도 처참했던 현장을 공개합니다.',
                type: 'article',
            },
            keywords: ['안양입주청소', '비포에프터클린', '후기', '입주청소', '리모델링청소', '분진제거', '새집증후군후기', '비포에프터클린후기', 'A/S후기'],
